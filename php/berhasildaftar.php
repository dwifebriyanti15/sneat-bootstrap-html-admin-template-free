...
>
  ...
  <body>
    <div class="text-center" style="margin-top: 20%;">
        <?php 
        $waktu = 5;
        echo "<div class='text-primary' style='font-size: 40px;'>Yeayyy..Kamu Berhasil Mendaftar</div>
        <div style='font-size: 20px;'>Sedang mengarahkan ke halaman login dalam <b>
        <span class='text-danger' id='waktu'".$waktu;
        echo"Jika dalam 5 detik tidak otomatis mendirect silahkan klik tombol dibawah.
